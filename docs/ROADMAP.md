...
- [ ] Exhaustively survey publicly accessible source families relevant to Pokémon FireRed, beginning from the original Japanese release and tracing every confirmed regional, language, revision, distribution, peripheral, and linked-system variant.
...
- [ ] Record known compression, packing, serialization, save, link, wireless, e-Reader, and peripheral formats.
