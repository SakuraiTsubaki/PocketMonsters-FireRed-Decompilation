...
This document is the authoritative coverage ledger for public-source research used by the Pocket Monsters FireRed decompilation project.
...
| Nintendo Japan | Product pages, support pages, Wireless Adapter/link/e-Reader documentation | In progress |
...
| Official guides / magazines / promotional material | Release, Sevii Islands, wireless, event, e-Reader, distribution and revision evidence | Not yet exhaustive |
...
| Physical cartridge evidence | Label codes, revision stamps, PCB/ROM/flash photos and component data | In progress |
| Technical hardware documentation | GBA header, Flash, link cable, multiboot, Wireless Adapter, e-Reader | Not yet exhaustive |
| Save/data-format research | Save sections, checksums, Pokémon structures, event structures, link data | In progress |
| Mystery Gift research | Wonder Card/News, event flags, distribution mechanics and regional differences | In progress |
| Official event/distribution preservation | AuroraTicket, MysticTicket and all FireRed-linked distributions | In progress |
| e-Reader / e-Card research | Japanese Battle-e and overseas support differences, trainer/card data and dot-code formats | In progress |
| Wireless Adapter research | Union Room, Mystery Gift, Trainer Tower/Hill-related behavior and regional differences | In progress |
| GameCube linkage | Colosseum, XD, Box and other GBA–GC interactions relevant to FireRed | Not yet exhaustive |
| Sevii Islands research | Maps, scripts, postgame, regional differences, event dependencies | Not yet exhaustive |
...
| Bug and revision research | Rev 0/Rev 1 behavior, fixes, side effects and language-specific changes | Not yet exhaustive |
...
| --- | --- | --- | --- | --- |
| OFF-JP-PKM-FRLG | https://www.pokemon.co.jp/game/gba/fl/ | Official | Japanese FireRed/LeafGreen product baseline, release/platform/wireless metadata | Observed |
| SRC-PRET-FRLG | https://github.com/pret/pokefirered | Source reconstruction | Major public FireRed/LeafGreen decompilation baseline; currently English-oriented and must not be generalized to Japanese targets | Observed |
| PRES-GEKKIO-BPRJ | https://gbhwdb.gekkio.fi/cartridges/AGB-BPRJ-0/ | Preservation / physical | Japanese FireRed cartridge identity, board/components and revision evidence | Observed |
| RE-PP-MYSTERY | https://projectpokemon.org/home/forums/topic/35903-gen-3-mystery-eventgift-research/ | Reverse engineering | Gen III Mystery Gift structures, scripts, flags, distributions and regional behavior | Observed |
...
Every research batch should record date checked, source family, search service/site, Japanese and non-Japanese query terms, result URLs reviewed, useful/duplicate/derivative/dead/inaccessible classification, and follow-up actions.
