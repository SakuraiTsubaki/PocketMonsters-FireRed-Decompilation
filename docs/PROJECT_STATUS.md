...
| --- | --- | --- | --- | --- | --- |
| Pokémon FireRed | Japan | Japanese | Rev 0 | Observed | Primary historical baseline; `AGB-BPRJ-0`; full public hash set recorded |
| Pokémon FireRed | Japan | Japanese | Rev 1 | Observed | Japanese revision branch; `AGB-BPRJ-1`; SHA-1 recorded |
| Pokémon FireRed | North America | English | Rev 0 / Rev 1 | Reproduced upstream / local verification pending | `pret/pokefirered` matching targets |
| Pokémon FireRed | Europe English branch | English | Rev 1 | Observed / mapping in progress | `AGB-BPRP-1`; do not invent Rev 0 |
| Pokémon FireRed | Other localized branches | German/French/Italian/Spanish | Rev 0 currently observed | Observed / inventory in progress | Product-code/hash matrix seeded in `VERSIONS.md` |

## Progress

- [x] Establish Japanese FireRed Rev 0 and Rev 1 baseline identities
...
1. Complete FireRed's official region/language/revision matrix.
2. Verify Japanese Rev 1 hashes and reconstruct its changes from Rev 0.
3. Separate North-American `BPRE` and European `BPRP` identities cleanly.
4. Inventory Japanese FireRed code/data plus Mystery Gift, Wireless Adapter, e-Reader, Sevii Islands, and GameCube-link evidence.
