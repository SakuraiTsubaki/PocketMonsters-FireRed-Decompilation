...
def fixture():
 d=bytearray(0x200);d[0xA0:0xAC]=b"POKEMON FIRE";d[0xAC:0xB0]=b"BPRJ";d[0xB0:0xB2]=b"01";d[0xB2]=0x96;d[0xBC]=0;d[0xBD]=(-sum(d[0xA0:0xBD])-0x19)&0xFF;return bytes(d)
class VerifyTargetTests(unittest.TestCase):
 def target(self,o,rev=0):return {"size":len(fixture()),"hashes":[{"algorithm":"sha1","value":o["sha1"]},{"algorithm":"sha256","value":o["sha256"]}],"header":{"title":"POKEMON FIRE","game_code":"BPRJ","maker_code":"01","software_version":rev,"header_checksum":o["header"]["header_checksum"]}}
