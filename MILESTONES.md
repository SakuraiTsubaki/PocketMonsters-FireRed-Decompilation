# Milestones: Pocket Monsters FireRed

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-FireRed-Decompilation`.
...
| Field | Current value |
| --- | --- |
| Target | Pocket Monsters FireRed |
...
Compare shared Generation III engine and resource structures with LeafGreen while keeping target identity and layout evidence separate.
