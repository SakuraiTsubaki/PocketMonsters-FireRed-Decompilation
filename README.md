...
A complete, target-specific workspace for reproducible research, analysis, tooling, source reconstruction, and retained non-ROM work products related to **Pocket Monsters FireRed**.

| Field | Value |
| --- | --- |
| Working target | Pocket Monsters FireRed |
| Platform family | Game Boy Advance |
| Series generation | Generation III |
| Exact build identity | Japanese retail `BPRJ` revision 0; identified, verification pending |
